...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Site,AudioHolder,WebSharper,Option,AudioVisualizer,Uint8Array,List,Html,Client,Default,Number,Seq,Operators,EventsPervasives,jQuery,Samples,T,window,ChannelSplitter,Set,TimeDomain,Client1,Builder,Operators1,Sample,document,Unchecked;
 Runtime.Define(Global,{
  Site:{
   AudioHolder:{
   ...
   AudioVisualizer:{
    Analyser:function()
    {
     ...
     return Option.iter(function(e)
     {
      ...
      e.buffer=AudioVisualizer.buffer().contents;
      e.loop=true;
      return e.start();
    ...
    {
     var x,_this;
     x=List.ofArray([Default.Width("1000"),Default.Height("325")]);
     _this=Default.Tags();
    ...
    DrawSpectrum:function(ctx,array)
    {
     ...
     list=AudioVisualizer.ToList(array);
    ...
    GenRadioButton:function(filter)
    {
     ...
     _this=Default.Attr();
     _this1=Default.Attr();
     x=Default.Input(List.ofArray([_this.NewAttr("type","radio"),_this1.NewAttr("name","filters")]));
     x1=function(_arg10_)
     {
     ...
     return Operators.add(Default.Div(List.ofArray([x])),List.ofArray([Default.Text(Global.String(filter))]));
    },
    ...
    Main:function(elem)
    {
     ...
     ignition=function(buff)
     {
      ...
      {
       var _this;
       AudioVisualizer.buffer().contents=bff;
       AudioVisualizer.Analyser();
       jQuery(AudioVisualizer.RadioGroup().get_Item(0).Dom).children().first().prop("checked","true");
       _this=Default.Attr();
       jQuery(elem).append(Operators.add(Default.Div(List.ofArray([_this.NewAttr("style","display: inline-block")])),AudioVisualizer.RadioGroup()).Dom);
       return;
      });
     };
   ...
   ChannelSplitter:{
    Analyser:function()
    {
     ...
     javascriptNode.onaudioprocess=function()
     {
      ...
      gainNode.gain.value=ChannelSplitter.volume().contents;
      return;
     };
     ...
     return Option.iter(function(e)
     {
      ...
      e.connect(gainNode);
      e.loop=true;
      e.buffer=ChannelSplitter.buffer().contents;
      return e.start();
    ...
    Canvas:Runtime.Field(function()
    {
     var x,_this,_this1;
     _this=Default.Attr();
     x=List.ofArray([Default.Width("60"),Default.Height("130"),_this.NewAttr("style","display: block;")]);
     _this1=Default.Tags();
     return _this1.NewTag("canvas",x);
    }),
    LoadSound:function($url,$callback)
    {
     var $0=this,$this=this;
    ...
    Main:function(elem)
    {
     ...
     jQuery(ChannelSplitter.VolumeControl().Dom).on("input",function()
     {
      ...
      ChannelSplitter.volume().contents=fraction*fraction;
      return false;
     });
     maind=Default.Div(List.ofArray([ChannelSplitter.Canvas(),ChannelSplitter.VolumeControl()]));
     ignition=function(buff)
     {
      return ChannelSplitter.context().decodeAudioData(buff,function(bff)
      {
       ChannelSplitter.buffer().contents=bff;
    ...
    VolumeControl:Runtime.Field(function()
    {
     ...
     _this1=Default.Attr();
     _this2=Default.Attr();
     return Default.Input(List.ofArray([_this.NewAttr("type","range"),Default.Attr().NewAttr("min","1"),Default.Attr().NewAttr("max","100"),_this1.NewAttr("value","100"),_this2.NewAttr("style","width: 60px")]));
    }),
    buffer:Runtime.Field(function()
    {
     return{
   ...
   Samples:{
    ...
    Sample:Runtime.Class({
     Show:function()
     {
      ...
      return Default.Div(List.ofArray([x,Operators.add(Default.A(List.ofArray([Default.Attr().Class("btn btn-primary btn-lg"),Default.HRef(url)])),List.ofArray([Default.Text("Source")]))])).AppendTo("sample-side");
     }
    }),
    Set:Runtime.Class({
     Show:function()
   ...
   TimeDomain:{
    Analyser:function()
    {
     ...
     return Option.iter(function(e)
     {
      ...
      e.buffer=TimeDomain.buffer().contents;
      e.loop=true;
      return e.start();
    ...
    CanvasEl:Runtime.Field(function()
    {
     var x,_this,_this1;
     _this=Default.Attr();
     x=List.ofArray([Default.Width("512"),Default.Height("256"),_this.NewAttr("style","background-color: black")]);
     _this1=Default.Tags();
     return _this1.NewTag("canvas",x);
    }),
    DrawTimeDomain:function(ctx,array)
    {
     var c,width,height,action,list;
    ...
    Main:function(elem)
    {
     ...
     ignition=function(buff)
     {
      ...
      {
       var _this;
       TimeDomain.buffer().contents=bff;
       TimeDomain.Analyser();
       jQuery(TimeDomain.RadioGroup().get_Item(0).Dom).children().first().prop("checked","true");
       _this=Default.Attr();
       jQuery(elem).append(Operators.add(Default.Div(List.ofArray([_this.NewAttr("style","display: inline-block")])),TimeDomain.RadioGroup()).Dom);
       return;
      });
     };
