...
declare module Site {
    ...
    module Samples {
        module Set {
            ...
            var Singleton : {
                (s: __ABBREV.__Samples.Sample): __ABBREV.__Samples.Set;
            };
        }
        interface Set {
            Show(): __ABBREV.__JQuery.JQuery;
        }
        interface Sample {
            Show(): void;
            FileName: string;
    ...
    module TimeDomain {
        var ToList : {
            (from: __ABBREV.__JavaScript.Uint8Array): __ABBREV.__List.T<number>;
        };
        var DrawTimeDomain : {
            (ctx: __ABBREV.__JavaScript.CanvasRenderingContext2D, array: __ABBREV.__JavaScript.Uint8Array): void;
        };
        var ButtonEvent : {
            (biq: __ABBREV.__JavaScript.BiquadFilterType, _arg2: __ABBREV.__Client.Element, _arg1: any): void;
        };
        var GenRadioButton : {
            (filter: __ABBREV.__JavaScript.BiquadFilterType): __ABBREV.__Client.Element;
        };
        var Analyser : {
            (): void;
        };
        ...
        var Main : {
            (elem: __ABBREV.__Dom.Element): void;
        };
        var context : {
            (): __ABBREV.__JavaScript.AudioContext;
        };
        var sourceNode : {
            (): __ABBREV.__WebSharper.OptionProxy<__ABBREV.__JavaScript.AudioBufferSourceNode>;
        };
        var filter : {
            (): __ABBREV.__JavaScript.BiquadFilterNode;
        };
        var buffer : {
            (): __ABBREV.__WebSharper.ref<__ABBREV.__JavaScript.AudioBuffer>;
        };
        var CanvasEl : {
            (): __ABBREV.__Client.Element;
        };
        var Filters : {
            (): __ABBREV.__List.T<__ABBREV.__JavaScript.BiquadFilterType>;
        };
        var RadioGroup : {
            (): __ABBREV.__List.T<__ABBREV.__Client.Element>;
        };
        var Sample : {
    ...
    module AudioVisualizer {
        var MkGradient : {
            (gradient: __ABBREV.__JavaScript.CanvasGradient): void;
        };
        var ToList : {
            (from: __ABBREV.__JavaScript.Uint8Array): __ABBREV.__List.T<number>;
        };
    ...
    module ChannelSplitter {
        ...
        var volume : {
            (): __ABBREV.__WebSharper.ref<number>;
        };
        var Sample : {
            (): __ABBREV.__Samples.Sample;
        };
    ...
    module AudioHolder {
        ...
        var SetCurrent : {
            (src: __ABBREV.__JavaScript.AudioBufferSourceNode): void;
        };
        var currentPlaying : {
            (): __ABBREV.__WebSharper.OptionProxy<__ABBREV.__JavaScript.AudioBufferSourceNode>;
        };
